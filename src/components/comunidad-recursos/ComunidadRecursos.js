...
// ============================================================================
// ComunidadRecursos — componente AISLADO y autocontenido.
//
...
// ciberseguridad). NO se integra a ninguna página del sitio — solo se
// previsualiza desde /dev/comunidad-recursos (ver ese page.js).
//
...
// Logo Champal blanco — asset YA existente en el proyecto (usado por el
// Footer), reutilizado tal cual (mismo wordmark + isotipo que pide el
// encabezado navy de este frame).
const LOGO_SRC = "/images/footer-logo-champal-blanco.svg";

// Triángulos decorativos — assets reales exportados desde el node de Figma
// (no se dibujan a mano; ver skill figma-design-to-code). Viven en su propia
// carpeta dev/ para no mezclarse con /public/images/comunidad/ (que
// pertenece al otro componente Comunidad.js).
const TRIANGLE = {
  pink: "/images/dev/comunidad-recursos/polygon-16.svg",
  green: "/images/dev/comunidad-recursos/polygon-17.svg",
  purple: "/images/dev/comunidad-recursos/polygon-18.svg",
  blue: "/images/dev/comunidad-recursos/polygon-19.svg",
  yellow: "/images/dev/comunidad-recursos/polygon-20.svg",
};
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 w-full" style={{ height: unit(80), background: HEADER_BG }}>
        ...
        <div className="absolute" style={{ left: x(1162), top: y(4.5), width: unit(160), height: unit(66) }}>
          <Image src={LOGO_SRC} alt="Colegio Champal" fill sizes="12vw" className="object-contain object-left" />
        </div>
      </div>
      ...
      <DIntro left={136} top={535} width={232}>
        Para reportarsituaciones de riesgo, maltrato o vulneración de derechos de menores.
      </DIntro>
      <DCard
        left={382}
        top={524}
      ...
      <DCard
        ...
        title={
          <>
            CONAPRED
            <div className="font-normal" style={{ fontSize: unit(10) }}>
              (Consejo Nacional para Preenir Discriminación)
            </div>
          </>
        }
      >
...
function MobileFrame() {
  return (
    <div className="flex flex-col gap-8 bg-white px-5 py-8 sm:px-8 lg:hidden">
      {/* Encabezado */}
      <div className="-mx-5 -mt-8 flex items-center justify-between px-5 py-5 sm:-mx-8 sm:px-8" style={{ background: HEADER_BG }}>
        ...
        <div className="relative h-10 w-24 shrink-0 sm:h-12 sm:w-28">
          <Image src={LOGO_SRC} alt="Colegio Champal" fill sizes="120px" className="object-contain object-right" />
        </div>
      </div>
      ...
      <section className="flex flex-col gap-4">
        ...
        <MCard
          ...
          title={
            <>
              CONAPRED
              <div className="text-[10px] font-normal leading-tight">(Consejo Nacional para Preenir Discriminación)</div>
            </>
          }
        >
          <p>
      ...
      <section className="flex flex-col gap-4">
        ...
        <MCard
          ...
          title={
            <>
              POLICÍA CIBERNÉTICA
              <div className="text-[10px] font-normal leading-tight">(Guardía Nacional)</div>
            </>
          }
        >
          <p>
