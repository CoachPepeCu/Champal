...
export const activities = [
  { id: "club-rayados", title: "CLUB RAYADOS", description: "Recibimos a niños y jóvenes que desean aprender el fútbol.", image: "club-rayados-rgba.png", imageAlt: "Ilustración de jugador de Club Rayados", headerColor: "#1e385b", left: 760, top: 109, grayTop: 16, titleTop: 5, titleWidth: 104, frontVariant: "tae", imageWidth: 111, imageHeight: 141, imageLeft: 12, imageTop: 33 },
  { id: "taller-poms", title: "TALLER DE POMS", description: "Motivamos la disciplina y arte a través de la música y habilidades de trabajo en equipo", image: "taller-poms-rgba.png", imageAlt: "Ilustración de estudiante con pompones", headerColor: "#580066", left: 967, top: 106, grayTop: 35, titleTop: 5, titleWidth: 104, frontVariant: "general", imageWidth: 111, imageHeight: 157, imageLeft: 23, imageTop: 20 },
  { id: "taller-ajedrez", title: "TALLER DE AJEDREZ", description: "Motivamos la disciplina y el uso de estrategias que cultiven la mente y el pensamiento crítico", image: "taller-ajedrez-rgba.png", imageAlt: "Ilustración de estudiante jugando ajedrez", headerColor: "#44484d", left: 1175, top: 111, grayTop: 16, titleTop: 5, titleWidth: 104, frontVariant: "general", imageWidth: 152, imageHeight: 133, imageLeft: -1, imageTop: 37 },
  { id: "tae-kwon-do", title: "TAE KWON DO", description: "Fortalecemos la disciplina, el respeto, la coordinación y la confianza a través de la práctica del Tae Kwon Do.", image: "tae-kwon-do-rgba.png", imageAlt: "Ilustración de estudiante practicando Tae Kwon Do", headerColor: "#bc0000", left: 134, top: 328, grayTop: 16, titleTop: 2, titleWidth: 78, frontVariant: "tae", imageWidth: 114, imageHeight: 121, imageLeft: 50, imageTop: 30 },
  { id: "taller-arte", title: "TALLER DE ARTE", description: "Promovemos habilidades artísticas como parte del desarrollo integral de la persona", image: "taller-arte-rgba.png", imageAlt: "Ilustración de estudiante pintando", headerColor: "#34ac00", left: 351, top: 328, grayTop: 15, titleTop: 5, titleWidth: 104, frontVariant: "arte", imageWidth: 107, imageHeight: 130, imageLeft: 77, imageTop: 40, accentWidth: 56.35, accentHeight: 63.75, accentLeft: 26.65, accentTop: 45.25 },
  { id: "taller-lego", title: "TALLER DE LEGO", description: "Con la ayuda de LEGO, los niños exploran matemáticas, ciencias y lenguaje", image: "taller-lego-rgba.png", imageAlt: "Ilustración de personaje de LEGO", headerColor: "#ff0004", left: 561, top: 328, grayTop: 23, titleTop: 5, titleWidth: 104, frontVariant: "general", imageWidth: 103, imageHeight: 134, imageLeft: 22, imageTop: 52 },
  { id: "taller-musica", title: "TALLER DE MÚSICA", description: "El espacio para seguir desarrollando habilidades artísticas dentro del colegio", image: "taller-musica-rgba.png", imageAlt: "Ilustración de estudiante tocando guitarra", headerColor: "#fecf3b", left: 755, top: 328, grayTop: 29, titleTop: 5, titleWidth: 104, frontVariant: "general", imageWidth: 105, imageHeight: 110, imageLeft: 21, imageTop: 57 },
  { id: "basquetbol", title: "BÁSQUETBOL", description: "Aprenden el trabajo en equipo, el compañerismo, la generosidad y la solidaridad, mientras desarrollan sus habilidades físicas.", image: "basquetbol-rgba.png", imageAlt: "Ilustración de jugador de básquetbol", headerColor: "#1e385b", left: 953, top: 327, grayTop: 33, titleTop: 5, titleWidth: 119, frontVariant: "general", imageWidth: 70, imageHeight: 159, imageLeft: 41, imageTop: 26 },
  { id: "taller-robotica", title: "TALLER DE ROBÓTICA", description: "Participamos en diversos torneos de robótica a nivel local, nacional e internacional", image: "taller-robotica-rgba.png", imageAlt: "Ilustración de robot", headerColor: "#5b94e1", left: 1142, top: 328, grayTop: 32, titleTop: 5, titleWidth: 104, frontVariant: "general", imageWidth: 66, imageHeight: 103, imageLeft: 42, imageTop: 61 },
  { id: "iniciacion-deportiva", title: "INICIACIÓN DEPORTIVA", description: "Desarrollo motriz, cognoscitivo y psicosocial a través de la inclusión", image: "iniciacion-deportiva-rgba.png", imageAlt: "Ilustración de grupo de iniciación deportiva", headerColor: "#6d8db8", left: 435, top: 534, grayTop: 17, titleTop: 5, titleWidth: 104, frontVariant: "general", imageWidth: 126, imageHeight: 126, imageLeft: 10, imageTop: 36 },
  { id: "taller-frances", title: "TALLER DE FRANCÉS", description: "Colaboración con la Alianza Francesa para acompañar en el aprendizaje de un tercer idioma", image: "taller-frances-rgba.png", imageAlt: "Ilustración de profesor con bandera de Francia", left: 645, top: 537, grayTop: 14, titleTop: 5, titleWidth: 104, frontVariant: "french", imageWidth: 120, imageHeight: 131, imageLeft: 21, imageTop: 35 },
  { id: "taller-ingles", title: "TALLER DE INGLÉS", description: "Extendemos el tiempo de inmersión en el idioma inglés para apoyarlos en su desempeño", image: "taller-ingles-rgba.png", imageAlt: "Ilustración de profesor con bandera del Reino Unido", left: 855, top: 537, grayTop: 14, titleTop: 5, titleWidth: 104, frontVariant: "english", imageWidth: 119, imageHeight: 141, imageLeft: 14, imageTop: 31 },
];
...
function FrontCard({ activity }) {
  ...
  return (
    <div className="frontCard ax-front" data-card-layer="frontCard">
      <div className="ax-front-surface" style={{ background: headerBackground(activity) }}>
...
function ActivityCard({ activity }) {
  ...
  return (
    <article className="activityCard ax-activity" style={style} data-activity-id={activity.id}>
      <div className="descriptionCard ax-description" data-card-layer="descriptionCard"><p>{activity.description}</p></div>
  ...
  return (
    <section className="actividades-x" aria-labelledby="actividades-x-title">
      <div className="ax-stage">
        <Image src={`${BASE}/fondo-nebula.png`} alt="" fill priority sizes="(min-width: 1440px) 1440px, 100vw" className="ax-background" />
        ...
        <div className="ax-cards">{activities.map((activity) => <ActivityCard key={activity.id} activity={activity} />)}</div>
      </div>
      <style>{`
        ...
        .ax-cards{position:relative;z-index:2;display:grid;grid-template-columns:150px;justify-content:center;justify-items:center;column-gap:16px;row-gap:24px}
        .ax-activity{position:relative;width:150px;height:250px;overflow:visible}.ax-description,.ax-front{position:absolute;top:0;left:0;width:150px}
        .ax-description{z-index:1;min-height:150px;padding:16px 12px;border:2px solid #fdc119;border-radius:10px;background:#fff;color:#000;text-align:center;font-size:11px;line-height:1.2;letter-spacing:.04em}.ax-description p{margin:0}
        .ax-front{z-index:2;height:150px;border:2px solid #fdc119;border-radius:8px}.ax-front-surface{position:absolute;inset:0;border-radius:6px}
        ...
        @media(min-width:1024px){
          ...
          .ax-header h1{margin-top:.694444cqw;font-size:3.194444cqw;line-height:3.472222cqw}.ax-cards{position:absolute;inset:0;display:block}
          ...
          .ax-description{min-height:10.416667cqw;padding:1.111111cqw .833333cqw;border-width:.138889cqw;border-radius:.694444cqw;font-size:.763889cqw}.ax-front{height:10.416667cqw;border-width:.138889cqw;border-radius:.555556cqw}.ax-front-surface{border-radius:.416667cqw}
