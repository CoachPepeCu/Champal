...
// "02_Accesos" de Kinder (node 82:1557) — mismo patrón que
// PreKinderAccesos.js (mismo panel "de vidrio" sobre fondo navy, mismo
// degradado, misma estructura de tarjeta), con el contenido/íconos propios
// de Kinder. Cada tarjeta enlaza a su sección correspondiente más abajo en
// esta misma página.
const ACCESOS = [
  {
    key: "ingles",
    ...
    icon: "/images/kinder/accesos-icono-ingles.png",
    href: "#ingles",
  },
  {
    key: "lecto-escritura",
    title: "Lecto-Escritura",
    desc: "El primer encuentro con las letras y la magia de las palabras",
    icon: "/images/kinder/accesos-icono-lecto.png",
    href: "#lecto-escritura",
  },
  {
    key: "logica-matematica",
    title: "Lógica-Matemática",
    desc: "Comprender el mundo a través de los números",
    icon: "/images/kinder/accesos-icono-logica.png",
    href: "#logica-matematica",
  },
  {
    key: "horarios",
    title: "Horarios y servicios",
    desc: "Disponibilidad en atención, con horarios flexibles",
    icon: "/images/kinder/accesos-icono-horarios.png",
    href: "#horarios-servicios",
  },
];

export default function KinderAccesos() {
  return (
    <section
      id="accesos"
