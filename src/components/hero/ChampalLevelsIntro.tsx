...
export default function ChampalLevelsIntro() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // PRE-TRIGGER:
      // Arranca el video apenas la sección comienza a entrar por la parte baja
      // del viewport. Así empieza aproximadamente en el segundo gesto de scroll,
      // mientras la sección anterior todavía termina de subir.
      const videoStartTrigger = ScrollTrigger.create({
        trigger: root,
        start: "top 88%",
        onEnter: restartVideo,
      ...
      const st = ScrollTrigger.create({
        ...
        // Si el pre-trigger ya lo arrancó, aquí NO lo reiniciamos.
        onEnter: ensureVideoPlaying,
        onEnterBack: ensureVideoPlaying,
        onLeave: () => video.pause(),
        onLeaveBack: () => {
          video.pause()
          video.currentTime = 0
      ...
      const onLoadedMetadata = () => {
        // En la Home integrada el componente se monta mucho antes de ser visible.
        // Por eso el video queda preparado en el primer frame y solo arranca
        // cuando esta sección entra realmente en pantalla.
        video.pause()
        video.currentTime = 0
